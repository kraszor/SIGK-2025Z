...
def train_model(data, init_features, input_size, epochs=10):
    try:
...
if __name__ == "__main__":
    ...
    best_val_loss, best_val_psnr = train_model((train_loader, val_loader), args.init_features, args.input_size, args.epochs)
