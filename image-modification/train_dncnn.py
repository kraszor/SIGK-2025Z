...
def train_dncnn(config, data_dir: str, checkpoint_dir: str = None):
...
def main(data_dir: str, num_samples: int = 10, num_epochs: int = 50, noise_level: float = 0.1):
    ...
    result = tune.run(
        tune.with_parameters(train_dncnn, data_dir=data_dir),
    ...
    final_model_path = "./best_dncnn_model.pth"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Train DnCNN with Ray Tune")
